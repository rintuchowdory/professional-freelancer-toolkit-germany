...
const navItems: NavItem[] = [
  ...
  { label: "Zeiterfassung", labelDe: "Stunden erfassen", href: "/zeiterfassung", icon: Clock },
  { label: "Angebote", labelDe: "Angebotsverwaltung", href: "/angebote", icon: FileText },
  { label: "Projekte", labelDe: "Projektübersicht", href: "/projekte", icon: Folder },
  { label: "Steuerrechner", labelDe: "Steuer berechnen", href: "/steuerrechner", icon: Calculator },
  { label: "Verträge", labelDe: "Vertragsverwaltung", href: "/vertraege", icon: FileSignature },
];
...
function PageTitle({ location }: { location: string }) {
 ...
 "/zeiterfassung": { title: "Zeiterfassung", subtitle: "Stunden erfassen & verwalten" },
 "/angebote": { title: "Angebote", subtitle: "Angebotsverwaltung" },
 "/projekte": { title: "Projektübersicht", subtitle: "Projekte verwalten" },
 "/steuerrechner": { title: "Steuerrechner", subtitle: "Steuer berechnen" },
 "/vertraege": { title: "Verträge", subtitle: "Vertragsverwaltung" },
